...
const Achievements = () => {
    const [cards, setCards] = useState([
        { id: 1, title: "1st Prize in 'Guess the Code'", date: "04/11/2023", description: "As part of a duo team, I won 1st prize in the 'Guess the Code' event at NAEVUS'23, organized by the Computer Society of India (CSI) of KEC. This coding competition featured participants from various departments, where we demonstrated exceptional coding skills and problem-solving abilities to emerge victorious." },
        ...
        { id: 3, title: "3rd prize in Paper Presentation", date: "24/04/2024", description: "I won 3rd prize in the paper presentation titled 'Machine Learning for Predicting Cloud Security' at Nacreous'24. Our paper focused on detecting DDOS attacks using SVM and J48 algorithms, demonstrating the application of machine learning techniques to enhance cloud security." },
