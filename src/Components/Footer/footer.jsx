                ...
                <div className="relative flex items-center justify-center" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}>
                    ...
                    {hovered && (
                        <motion.div
                            ...
                            className="absolute top-[-57px] cursor-pointer -left-8 transform -translate-x-1/2 flex text-xs flex-col items-center justify-center rounded-xl bg-black z-50 shadow-xl px-4 py-2">
