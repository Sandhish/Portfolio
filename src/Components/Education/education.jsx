            ...
            <div className="flex justify-center">
                <ol className="relative border-l-2 border-gray-200 dark:border-gray-700 lg:flex lg:justify-between lg:w-full lg:border-0 lg:before:content-[''] lg:before:absolute lg:before:top-3 lg:before:left-0 lg:before:right-0 lg:before:h-0.5 lg:before:bg-gray-200 dark:lg:before:bg-gray-700">
                    ...
                    <motion.li whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -70 }} transition={{ duration: 0.7, delay: 0.2 }}
                        ...
                        <span className="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900 lg:static lg:mb-4">
                        ...
                        <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white lg:mt-0 lg:mb-1">SSLC</h3>
                    ...
                    <motion.li whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -70 }} transition={{ duration: 0.7, delay: 0.3 }}
                        ...
                        <h3 className="mb-1 text-lg font-semibold text-gray-900 dark:text-white lg:mt-0 lg:mb-1">HSC</h3>
                    ...
                    <motion.li whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -70 }} transition={{ duration: 0.7, delay: 0.4 }}
                        ...
                        <span className="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900 lg:static lg:mb-4">
                            <svg className="w-4 h-4 text-gray-500 lg:w-5 lg:h-5 dark:text-gray-100" aria-hidden="true" fill="currentColor" viewBox="0 0 22 16">
                                <path d="M18 0H2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2ZM6.5 3a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5ZM3.014 13.021l.157-.625A3.427 3.427 0 0 1 6.5 9.571a3.426 3.426 0 0 1 3.322 2.805l.159.622-6.967.023ZM16 12h-3a1 1 0 0 1 0-2h3a1 1 0 0 1 0 2Zm0-3h-3a1 1 0 1 1 0-2h3a1 1 0 1 1 0-2Zm0-3h-3a1 1 0 1 1 0-2h3a1 1 0 1 1 0-2Z" />
                            </svg>
                        </span>
                        <h3 className="mb-1 text-lg font-semibold text-gray-900 dark:text-white lg:mt-0 lg:mb-1">B.E CSE</h3>
