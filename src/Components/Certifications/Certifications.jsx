...
const Certifications = () => {
    ...
    return (
        <div className="border-b border-neutral-800 pb-16" id="certifications">
            ...
            <Swiper className="mx-auto max-w-[850px]" loop={true} grabCursor={true} spaceBetween={24}
                pagination={{
                    clickable: true,
                }}
                breakpoints={{
            ...
            >
                {certifications.map(({ id, img, title, desc }) => (
                    <SwiperSlide className="bg-transparent border border-gray-200 p-6 rounded-2xl mb-12 flex flex-col gap-4" key={id} >
