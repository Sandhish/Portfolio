...
export const PROJECTS = [
  {
    ...
    description:
      "Designed and developed a Language Translator using hugging face models, this will be used to identify the given language and to translate to the required language.",
    technologies: ["Hugging Face", "Transformers", "Gradio", "MarianMT"],
  },
  {
    title: "Thirukkural CRUD",
